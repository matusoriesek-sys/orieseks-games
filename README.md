...
Detektívne a únikové hry pre deti. Webová appka (PWA) — dá sa pridať na plochu telefónu
a po prvom otvorení funguje aj bez internetu.

- `index.html` — celá appka (herňa + hry)
